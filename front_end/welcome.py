...
class welcome:
    def __init__(self, window):
        ...
        self.lb_heading = Label(self.wn, text='Welcome', bg='lavender', fg="dark blue",
                                font=('arial', 20, 'bold'))
        ...
        # Button
        self.btn_wep = Button(self.wn, text='Student Management System', fg='dark blue', bg='lavender', font=('arial', 14, 'bold'), bd='6',
                              command=self.btn_student_click)
        self.btn_wep.place(x=753, y=400,)

        self.btn_arm = Button(self.wn, text='Teacher Management System', fg='dark blue', bg='lavender', font=('arial', 14, 'bold'), bd='6',
                              command=self.btn_teacher_click)
        self.btn_arm.place(x=750, y=500,)


        self.btn_exit = Button(self.wn, text='Exit', fg='dark blue', bg='lavender', font=('arial', 14, 'bold'), bd='6',
