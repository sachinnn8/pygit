...
class login_system:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Login System",font=('arial',40,'bold'),bd=4, relief=GROOVE,bg='lavender',fg='dark blue')
        title.place(x=0,y=0,relwidth=1)

        login_frame=Frame(self.root,bg='sky blue')
        ...
        btn_login=Button(login_frame,text='Login',width=15,command=self.login,font=('arial',14,'bold'), bg='blue', fg='lavender')
