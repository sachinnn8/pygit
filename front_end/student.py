...
class student:
    def __init__(self,root):
        ...
        title=Label(self.root,text='Student Management System',bd=10,relief=RIDGE,font=('arial',40,'bold'),bg='light green',fg='white')
        ...
        Manage_frame=Frame(self.root,bd=4,relief=GROOVE,bg='light green')
...
#button
        Btn_frame = Frame(Manage_frame,bd=1, relief=GROOVE, bg='light green')
        ...
        Detail_frame = Frame(self.root, bd=4, relief=GROOVE, bg='light green')
...
#table frame
        Table_frame = Frame(Detail_frame, bd=4, relief=GROOVE, bg='light green')
